...
import AddGoodsModal from './cpns/addGoodsModal';
...
} from '../categories/store/actionCreators';
...
export default function Goods() {
    ...
    const showModal = () => {
       ...
       dispatch(getCategoryTotalDispatch({type:2}));
       
       dispatch(changeAddGoodsModalVisable(true));
    }
